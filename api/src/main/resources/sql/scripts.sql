...
VALUES
    ('Happy', 'happy@example.com', '9876548337', '$2y$12$oRRbkNfwuR8ug4MlzH5FOeui.//1mkd.RsOAJMbykTSupVy.x/vb2', 'admin', CURRENT_DATE);
...
VALUES
    ('Home Loan Interest rates reduced', 'Home loan interest rates are reduced as per the government guidelines. The updated rates will be effective immediately', CURRENT_DATE - INTERVAL '30 days', CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE, null),
...
-- Inserciones iniciales en la tabla authorities
...
-- Borra todas las filas de la tabla authorities
DELETE FROM authorities;

-- Inserta nuevos roles en la tabla authorities
INSERT INTO authorities (customer_id, name)
VALUES (1, 'ROLE_USER'),
       (1, 'ROLE_ADMIN');